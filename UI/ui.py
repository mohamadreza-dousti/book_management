...
class Ui(ctk.CTk):
    ...
    def add_book(self):
        ...
        self.save_btn_avalable = ctk.CTkButton(self.display, text='save', command=lambda:self.ejra.save(self.title, self.author, self.avalable, self.save_btn_avalable))
    ...
    def remove_book(self):
        ...
        self.remove_btn_avalable = ctk.CTkButton(self.display, text='remove', command=lambda:self.ejra.remove(self.title_rem, self.remove_btn_avalable))
    ...
    def search_book(self):
        ...
        self.filter = ctk.CTkOptionMenu(self.display, values=self.option, variable=self.filter_var, command=lambda value:self.ejra.search(self.title_ser, self.scroll_frame,self.filter, value))
        self.filter.pack(pady=3)

        self.search_btn_avalable = ctk.CTkButton(self.display, text='search', command=lambda:self.ejra.search(self.title_ser, self.scroll_frame, self.filter))
    ...
    def show_books(self):
        ...
        self.show_btn_avalable = ctk.CTkButton(self.display, text='show books', command=lambda:self.ejra.show(self.show_btn_avalable, self.scroll_frame))
